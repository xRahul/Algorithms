...
public class LinearSearchTest {
  ...
  public void integerLinearSearchIsWorking_whenElementIsPresent() {
    linearSearchIntegers.setList(UNSORTED_LIST_INTEGERS);
    int position = linearSearchIntegers.search(UNSORTED_LIST_INTEGER_PRESENT);
  ...
  public void integerLinearSearchIsWorking_whenElementIsAbsent() {
    linearSearchIntegers.setList(UNSORTED_LIST_INTEGERS);
    int position = linearSearchIntegers.search(UNSORTED_LIST_INTEGER_ABSENT);
    assertEquals(NOT_FOUND, position);
  }

  @Test
  public void stringLinearSearchIsWorking_whenElementIsPresent() {
    linearSearchStrings.setList(UNSORTED_LIST_STRINGS);
    int position = linearSearchStrings.search(UNSORTED_LIST_STRING_PRESENT);
    assertNotEquals(NOT_FOUND, position);
  }
  ...
  public void stringLinearSearchIsWorking_whenElementIsAbsent() {
    linearSearchStrings.setList(UNSORTED_LIST_STRINGS);
    int position = linearSearchStrings.search(UNSORTED_LIST_STRING_ABSENT);
    assertEquals(NOT_FOUND, position);
  }
}
